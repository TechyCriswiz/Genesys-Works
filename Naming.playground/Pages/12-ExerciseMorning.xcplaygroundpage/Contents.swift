...
let totalTimeSpentGettingReady = walkDogs + eatBreakfast + brushTeeth + chooseClothes + watchYoutube + startCar
...
let totalTimeSpentDoingMusts = walkDogs + eatBreakfast + brushTeeth + chooseClothes + startCar

let totalTimeSpentDoingExtras = watchYoutube 
/*:
